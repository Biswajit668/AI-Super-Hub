        ...
        <div className="p-4 flex-1 overflow-y-auto">
          ...
          <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800/80 space-y-1">
            ...
            <button
              ...
              className={`
                w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-medium transition
                ${activeView === 'analytics' ? 'bg-indigo-50 dark:bg-indigo-600/20 text-indigo-600 dark:text-indigo-300 font-bold border border-indigo-200 dark:border-indigo-500/30' : 'hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}
              `}
            >
